...
function twentytwelve_scripts_styles() {
	...
	// Loads the Pagination Style
	wp_enqueue_style( 'twentytwelve-pagi', get_template_directory_uri() . '/css/pagination.css', array( 'twentytwelve-style' ), '20121010' );


// Loads the Colorbox
	wp_enqueue_style( 'twentytwelve-color', get_template_directory_uri() . '/css/colorbox.css', array( 'twentytwelve-style' ), '20121010' );
// Loads the Social
	wp_enqueue_style( 'twentytwelve-social', get_template_directory_uri() . '/css/social.css', array( 'twentytwelve-style' ), '20121010' );

	// Loads the Social
	wp_enqueue_style( 'twentytwelve-skin', get_template_directory_uri() . '/css/skin.css', array( 'twentytwelve-style' ), '20121010' );
